...
var NwuMR = function (_Component) {
  _inherits(NwuMR, _Component);

  function NwuMR() {
    _classCallCheck(this, NwuMR);

    return _possibleConstructorReturn(this, (NwuMR.__proto__ || Object.getPrototypeOf(NwuMR)).apply(this, arguments));
  }
...
_metalSoy2.default.register(NwuMR, _step_4Soy2.default);

exports.default = NwuMR;
...
exports.templates = exports.NwuMR = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace NwuMR.
   * @public
   */

  goog.module('NwuMR.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'NwuMR.render';
  }
...
_metalSoy2.default.register(NwuMR, templates);
exports.NwuMR = NwuMR;
