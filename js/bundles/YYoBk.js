...
var YYoBk = function (_Component) {
  _inherits(YYoBk, _Component);

  function YYoBk() {
    _classCallCheck(this, YYoBk);

    return _possibleConstructorReturn(this, (YYoBk.__proto__ || Object.getPrototypeOf(YYoBk)).apply(this, arguments));
  }
...
_metalSoy2.default.register(YYoBk, _step_4Soy2.default);

exports.default = YYoBk;
...
exports.templates = exports.YYoBk = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace YYoBk.
   * @public
   */

  goog.module('YYoBk.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'YYoBk.render';
  }
...
_metalSoy2.default.register(YYoBk, templates);
exports.YYoBk = YYoBk;
