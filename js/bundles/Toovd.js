...
var Toovd = function (_Component) {
  _inherits(Toovd, _Component);

  function Toovd() {
    _classCallCheck(this, Toovd);

    return _possibleConstructorReturn(this, (Toovd.__proto__ || Object.getPrototypeOf(Toovd)).apply(this, arguments));
  }
...
_metalSoy2.default.register(Toovd, _indexSoy2.default);

exports.default = Toovd;
...
exports.templates = exports.Toovd = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace Toovd.
   * @public
   */

  goog.module('Toovd.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'Toovd.render';
  }
...
_metalSoy2.default.register(Toovd, templates);
exports.Toovd = Toovd;
