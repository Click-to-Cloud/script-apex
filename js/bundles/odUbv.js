...
var odUbv = function (_Component) {
  _inherits(odUbv, _Component);

  function odUbv() {
    _classCallCheck(this, odUbv);

    return _possibleConstructorReturn(this, (odUbv.__proto__ || Object.getPrototypeOf(odUbv)).apply(this, arguments));
  }
...
_metalSoy2.default.register(odUbv, _step_4Soy2.default);

exports.default = odUbv;
...
exports.templates = exports.odUbv = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace odUbv.
   * @public
   */

  goog.module('odUbv.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'odUbv.render';
  }
...
_metalSoy2.default.register(odUbv, templates);
exports.odUbv = odUbv;
