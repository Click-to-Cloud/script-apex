...
var erPtD = function (_Component) {
  _inherits(erPtD, _Component);

  function erPtD() {
    _classCallCheck(this, erPtD);

    return _possibleConstructorReturn(this, (erPtD.__proto__ || Object.getPrototypeOf(erPtD)).apply(this, arguments));
  }
...
_metalSoy2.default.register(erPtD, _indexSoy2.default);

exports.default = erPtD;
...
exports.templates = exports.erPtD = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace erPtD.
   * @public
   */

  goog.module('erPtD.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'erPtD.render';
  }
...
_metalSoy2.default.register(erPtD, templates);
exports.erPtD = erPtD;
