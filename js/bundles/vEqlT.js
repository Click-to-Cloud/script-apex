...
var vEqlT = function (_Component) {
  _inherits(vEqlT, _Component);

  function vEqlT() {
    _classCallCheck(this, vEqlT);

    return _possibleConstructorReturn(this, (vEqlT.__proto__ || Object.getPrototypeOf(vEqlT)).apply(this, arguments));
  }
...
_metalSoy2.default.register(vEqlT, _indexSoy2.default);

exports.default = vEqlT;
...
exports.templates = exports.vEqlT = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace vEqlT.
   * @public
   */

  goog.module('vEqlT.incrementaldom');
  ...
  function $render(opt_data, opt_ignored, opt_ijData) {
    var param336 = function param336() {
      ...
      itext('For example,');
      ie_close('p');
      $templateAlias2({ code: 'ScriptEngine.getInstance.eval(\'["a", "b"]\'); // Array literal\n\nScriptEngine.getInstance.eval(\'{ "name": "test", age: 18 }\'); // Object literal', mode: 'java' }, null, opt_ijData);
      ie_close('article');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'vEqlT.render';
  }
...
_metalSoy2.default.register(vEqlT, templates);
exports.vEqlT = vEqlT;
