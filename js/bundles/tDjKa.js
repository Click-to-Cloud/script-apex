...
var tDjKa = function (_Component) {
  _inherits(tDjKa, _Component);

  function tDjKa() {
    _classCallCheck(this, tDjKa);

    return _possibleConstructorReturn(this, (tDjKa.__proto__ || Object.getPrototypeOf(tDjKa)).apply(this, arguments));
  }
...
_metalSoy2.default.register(tDjKa, _indexSoy2.default);

exports.default = tDjKa;
...
exports.templates = exports.tDjKa = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace tDjKa.
   * @public
   */

  goog.module('tDjKa.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'tDjKa.render';
  }
...
_metalSoy2.default.register(tDjKa, templates);
exports.tDjKa = tDjKa;
