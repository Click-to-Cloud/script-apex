...
goog.loadModule(function (exports) {
  ...
  function $header(opt_data, opt_ignored, opt_ijData) {
    ...
    ie_open('a', null, null, 'href', '/script-apex/tutorials/getting_started/step_1.html', 'class', 'btn btn-accent btn-sm');
    itext('Get Started');
    ie_close('a');
    ie_open('a', null, null, 'href', 'https://github.com/Click-to-Cloud/Script.apex/', 'class', 'btn btn-success btn-sm');
    itext('GitHub');
    ie_close('a');
  ...
  function $why(opt_data, opt_ignored, opt_ijData) {
    ...
    itext('Why Script.apex?');
    ie_close('h3');
    ie_open('p', null, null, 'class', 'about-description');
    itext('Script.apex help you run JavaScript code in Apex. Basically, it compiles JavaScript code into semantic nodes, which are then evaluated in native Apex. The JavaScript expression parser in Script.apex is porting from ');
    ie_open('a', null, null, 'href', 'http://jsep.from.so/');
    itext('jsep');
    ie_close('a');
    itext('.');
    ie_close('p');
  ...
  function $features(opt_data, opt_ignored, opt_ijData) {
    ...
    itext('Expression Parsing');
    ie_close('h3');
    ie_open('p', null, null, 'class', 'feature-description');
    itext('Script.apex parses JavaScript expressions into symantic nodes.');
    ie_close('p');
    ie_close('section');
    ie_open('section', null, null, 'class', 'feature col-md-4');
    ie_open('h3', null, null, 'class', 'feature-title');
    itext('Expression Evaluation');
    ie_close('h3');
    ie_open('p', null, null, 'class', 'feature-description');
    itext('Script.apex evaluates JavaScript expressions to compute the result.');
    ie_close('p');
    ie_close('section');
    ie_open('section', null, null, 'class', 'feature col-md-4');
    ie_open('h3', null, null, 'class', 'feature-title');
    itext('Cached Parsing');
    ie_close('h3');
    ie_open('p', null, null, 'class', 'feature-description');
    itext('Script.apex caches parsed JavaScript expressions to improve performance.');
    ie_close('p');
    ie_close('section');
    ie_close('div');
    ie_close('div');
  ...
  function $how(opt_data, opt_ignored, opt_ijData) {
    ...
    ie_close('h3');
    ie_open('p', null, null, 'class', 'about-description');
    itext('To evaluate a JavaScript expression in Script.apex, you really need only one API. That\'s it.');
    ie_close('p');
    ie_close('div');
    ie_close('div');
    ie_close('div');
  ...
  function $highlights(opt_data, opt_ignored, opt_ijData) {
    ...
    itext('Script Evaluation');
    ie_close('h4');
    ie_open('p', null, null, 'class', 'highlight-description');
    itext('Script.apex evaluates JavaScript expressions to provide dynamic scripting feature to Apex.');
    ie_close('p');
    ie_close('div');
    ie_open('div', null, null, 'class', 'col-md-5 col-md-offset-1');
    ie_open('img', null, null, 'class', 'highlight-image', 'src', '/script-apex/images/highlight_1.png', 'alt', 'Fluent API', 'height', '200');
    ie_close('img');
    ie_close('div');
    ie_close('section');
    ie_open('section', null, null, 'class', 'highlight row');
    ...
    ie_open('h4', null, null, 'class', 'highlight-title');
    itext('Context Evaluation');
    ie_close('h4');
    ie_open('p', null, null, 'class', 'highlight-description');
    itext('Script.apex uses variables from context to provide dynamic evaluations.');
    ie_close('p');
    ie_close('div');
    ie_open('div', null, null, 'class', 'col-md-5 col-md-offset-2 col-md-pull-6');
    ie_open('img', null, null, 'class', 'highlight-image', 'src', '/script-apex/images/highlight_2.png', 'alt', 'Collection Support', 'height', '200');
    ie_close('img');
    ie_close('div');
    ie_close('section');
    ie_open('section', null, null, 'class', 'highlight row');
    ...
    ie_close('h4');
    ie_open('p', null, null, 'class', 'highlight-description');
    itext('Script.apex creates parsed symantic nodes right at your disposal.');
    ie_close('p');
    ie_close('div');
    ie_open('div', null, null, 'class', 'col-md-5 col-md-offset-1');
    ie_open('img', null, null, 'class', 'highlight-image', 'src', '/script-apex/images/highlight_3.png', 'alt', 'Function Composition', 'height', '200');
    ie_close('img');
    ie_close('div');
    ie_close('section');
    ie_close('div');
