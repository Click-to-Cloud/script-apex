...
var IOyfp = function (_Component) {
  _inherits(IOyfp, _Component);

  function IOyfp() {
    _classCallCheck(this, IOyfp);

    return _possibleConstructorReturn(this, (IOyfp.__proto__ || Object.getPrototypeOf(IOyfp)).apply(this, arguments));
  }
...
_metalSoy2.default.register(IOyfp, _step_4Soy2.default);

exports.default = IOyfp;
...
exports.templates = exports.IOyfp = undefined;
...
goog.loadModule(function (exports) {
  ...
  /**
   * @fileoverview Templates in namespace IOyfp.
   * @public
   */

  goog.module('IOyfp.incrementaldom');
  ...
  if (goog.DEBUG) {
    $render.soyTemplateName = 'IOyfp.render';
  }
...
_metalSoy2.default.register(IOyfp, templates);
exports.IOyfp = IOyfp;
